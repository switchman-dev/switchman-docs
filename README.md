...
Documentation site for [Switchman](https://switchman.dev) — the operating system for parallel AI development.

Live at **[docs.switchman.dev](https://docs.switchman.dev)**
